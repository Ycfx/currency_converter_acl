export default function(target, settings) {
	...
	this.buildSelect = function() {
		...
		this.display.innerHTML = this.target.getAttribute('placeholder');
		this.display.classList.add("select_placeholder");
	...
	this.buildFilter = function() {
		...
		this.clear.classList.add('select_clear');
		this.clear.addEventListener('click', this.handleClearSelect.bind(this));
		wrapper.appendChild(this.filter);
		wrapper.appendChild(this.clear);
	...
	this.handleOptionClick = function(e) {
		...
		{
			this.display.classList.remove("select_placeholder");
	...
	this.handleClearSelect = function(e) {
		this.display.innerHTML = this.target.getAttribute('placeholder');
		this.display.classList.add("select_placeholder");
